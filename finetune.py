...
python train.py --data ./data/huggingface/oscar_split_ViT-B_32_train.pkl  --out_dir ./hugging_train/
...
def load_model(config_path: str, epoch_or_latest: Union[str, int] = '_latest'):
    ...
    if args.only_prefix:
        ...
        weights_path = "/home/albert/tests/coco/coco_weights.pt"
        state_dict = torch.load(weights_path, map_location=torch.device('cpu'))
        print(state_dict)
        model.load_state_dict(state_dict, strict=False)

  # Replace with your weights file path
...
def main():
    ...
    if args.only_prefix:
        ...
        model = ClipCaptionModel(prefix_length, clip_length=args.prefix_length_clip, prefix_size=prefix_dim,
                                  num_layers=args.num_layers, mapping_type=args.mapping_type)
        weights_path = "/home/albert/tests/data/coco/coco_weights.pt"
        state_dict = torch.load(weights_path, map_location=torch.device('cpu'))
        print(state_dict)
        model.load_state_dict(state_dict, strict=False)
